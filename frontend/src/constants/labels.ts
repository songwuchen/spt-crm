...
export const approvalBizTypeLabels: Record<string, string> = {
  ...
  salesperson_region_map: '业务员区域经理',
  quote_management: '报价管理',
  '报价管理': '报价管理',
  pricing_checklist_hjqd: '核价清单传递',
  '核价清单传递': '核价清单传递',
  '核价清单传递流程HJQD': '核价清单传递',
  tech_agreement_feedback: '技术协议反馈单',
  '技术协议反馈单': '技术协议反馈单',
  contract_outsource_early: '合同外购件提前安排流程',
  '合同外购件提前安排流程': '合同外购件提前安排流程',
  research_coop_card: '中央研究院协同卡',
  '中央研究院协同卡': '中央研究院协同卡',
  cs_service_request: '客户服务申请',
  cs_product_replace: '产品更换补发',
  cs_product_return: '产品工具退回',
  cs_loan_slip: '客服借据',
  cs_drawing_request: '客服领图',
  cs_service_delay: '服务延期申请',
  cs_correspondence: '客服往来函件',
  '客户服务申请及反馈': '客户服务申请',
  '售出产品更换（补发）流程': '产品更换补发',
  '售出产品更换（补发）': '产品更换补发',
  '售出产品/工具退回流程SCCP/GJTH': '产品工具退回',
  '售出产品/工具退回': '产品工具退回',
  '客服借据': '客服借据',
  '客户服务延期申请': '服务延期申请',
  '客服往来函件KFWLHJ': '客服往来函件',
...
/** 合同登记是否可编辑（仅已终止不可改；含审批中） */
export function isContractEditable(
  contractStatus: string,
  _versionStatus?: string | null,
  _wfStatus?: string | null,
  _approvalFlowStatus?: string | null,
): boolean {
