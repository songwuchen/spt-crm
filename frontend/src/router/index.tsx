...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      // 扩展平台设计入口仅系统管理员；填报/数据页仍给业务模块复用
      { path: 'lowcode/forms', element: <Guard permission="role:manage"><FormTemplateList /></Guard> },
      { path: 'lowcode/forms/:id/design', element: <Guard permission="role:manage"><FormDesignerPage /></Guard> },
      ...
      { path: 'lowcode/workflows', element: <Guard permission="role:manage"><WorkflowList /></Guard> },
      { path: 'lowcode/workflows/:id/design', element: <Guard permission="role:manage"><WorkflowDesignerPage /></Guard> },
      { path: 'lowcode/approvals', element: <RedirectLowcodeApprovals /> },
      { path: 'lowcode/dashboards', element: <Guard permission="role:manage"><LcDashboardList /></Guard> },
      { path: 'lowcode/dashboards/:id', element: <Guard permission="role:manage"><LcDashboardPage /></Guard> },
      { path: 'lowcode/entity-fields', element: <Guard permission="role:manage"><LcEntityFieldsAdmin /></Guard> },
      ...
      { path: 'cs-drawing-requests/fill', element: <Guard permission="form_data:create"><FormModuleFillPage templateCode="cs_drawing_request" listPath="/cs-drawing-requests" title="客服领图" /></Guard> },
      { path: 'cs-drawing-requests', element: <Guard permission="form_data:view"><FormModulePage templateCode="cs_drawing_request" title="客服领图" basePath="/cs-drawing-requests" /></Guard> },
      ...
      { path: 'biz-bonus-transfer/fill', element: <Guard permission="form_data:create"><FormModuleFillPage templateCode="biz_bonus_transfer" listPath="/biz-bonus-transfer" title="业务奖金流转单" /></Guard> },
      { path: 'biz-bonus-transfer', element: <Guard permission="form_data:view"><FormModulePage templateCode="biz_bonus_transfer" title="业务奖金流转单" basePath="/biz-bonus-transfer" /></Guard> },
      { path: 'biz-bonus-biz-initiate/fill', element: <Guard permission="form_data:create"><FormModuleFillPage templateCode="biz_bonus_biz_initiate" listPath="/biz-bonus-biz-initiate" title="业务奖金流转—业务发起" /></Guard> },
