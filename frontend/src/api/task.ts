...
export const taskApi = {
  ...
  batchAssign: (ids: string[], assignee_id: string, assignee_name: string) =>
    client.post('/api/v1/tasks/batch_assign', { ids, assignee_id, assignee_name }),
  batchComplete: (ids: string[]) =>
    client.post('/api/v1/tasks/batch_complete', { ids }),
}
