const enUS = {
  ...
  nav: {
    ...
    csServiceRequests: 'CS Service Requests',
    csProductReplaces: 'Product Replace',
    csProductReturns: 'Product Returns',
    csLoanSlips: 'CS Loan Slips',
    csDrawingRequests: 'CS Drawing Request',
    csServiceDelays: 'Service Delay',
    csCorrespondences: 'CS Correspondence',
  ...
  lead: {
    ...
    batchConvert: 'Batch Convert to Opportunities',
    batchConvertConfirm: 'Convert {count} selected leads to opportunities?',
    batchConvertDone: '{count} leads converted to opportunities',
