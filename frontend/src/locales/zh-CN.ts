...
const zhCN = {
  ...
  nav: {
    ...
    researchCoopCards: '中央研究院协同卡',
    techAgreementFeedbacks: '技术协议反馈单',
    contracts: '合同管理',
    ...
    contractOutsourceEarly: '合同外购件提前安排流程',
    ...
    payments: '回款管理',
    commissions: '业务提成',
    bizBonusTransfer: '业务奖金流转单',
    bizBonusBizInitiate: '业务奖金流转—业务发起',
    commissionDatabase: '提成数据库',
    bizBonusPaymentDashV1: '业务奖金流转单支付情况（可修改）',
    bizBonusPaymentDashV2: '业务奖金流转单支付情况',
    collection: '应收清欠',
    guarantees: '保函管理',
    equipmentProfile: '工艺设备档案',
    serviceTickets: '售后工单',
    csServiceRequests: '客户服务申请',
    csProductReplaces: '产品更换补发',
    csProductReturns: '产品工具退回',
    csLoanSlips: '客服借据',
    csDrawingRequests: '客服领图',
    csServiceDelays: '服务延期申请',
    csCorrespondences: '客服往来函件',
    measurements: '售后实测数据',
    salesTargets: '销售目标',
    renewals: '续约管理',
    analytics: '报表中心',
