#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""205：收款登记抄送 n27 规则修正 + 钉钉抄送卡专属字段；触发流程升级。"""
...
OUT = ROOT / "_hotpatch_payment_cc_notify_205.txt"

FILES = (
    ("backend/app/domains/lowcode/workflow_service.py", "/app/app/domains/lowcode/workflow_service.py"),
    ("backend/app/domains/lowcode/wf_notify.py", "/app/app/domains/lowcode/wf_notify.py"),
)
...
def main() -> None:
    ...
    for i, (local_rel, remote) in enumerate(FILES):
        local = ROOT / local_rel
        tmp = f"/tmp/_hotpatch_payment_{i}.py"
