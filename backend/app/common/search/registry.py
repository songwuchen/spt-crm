...
def _build_registry() -> dict:
    ...
    reg["lead"] = ResourceSchema("lead", "线索", [
        ...
        PeopleField("reporter_id", "报备人", Lead.reporter_id, option_source="users"),
        TextField("reporter_name", "报备人姓名", Lead.reporter_name),
        DateField("reported_at", "报备时间", Lead.reported_at, is_datetime=True),
