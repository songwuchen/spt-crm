...
def _customer_dict(c, tenant_rules: dict | None = None, pools=None) -> dict:
    ...
    return {
        ...
        # 对齐简道云「客户信息」
        "is_smart_filing": c.is_smart_filing,
        "is_foreign_trade": c.is_foreign_trade,
        "registered_capital": float(c.registered_capital) if c.registered_capital is not None else None,
        "paid_in_capital": float(c.paid_in_capital) if c.paid_in_capital is not None else None,
        "founded_year": c.founded_year,
        "parent_company_note": c.parent_company_note,
        "customer_nature": c.customer_nature,
        "customer_relation": c.customer_relation,
        "primary_contact_title": c.primary_contact_title,
        "wage_insurance_status": c.wage_insurance_status,
        "is_company_customer": c.is_company_customer,
        "taxpayer_id": c.taxpayer_id,
        "invoice_address_phone": c.invoice_address_phone,
        "bank_account": c.bank_account,
        "foreign_customer_code": c.foreign_customer_code,
        "foreign_customer_type": c.foreign_customer_type,
        "focus_product": c.focus_product,
        "customer_email": c.customer_email,
        "main_products_json": c.main_products_json,
        "legal_person": c.legal_person,
        "smart_industry_category": c.smart_industry_category,
        "annual_run_days": c.annual_run_days,
        "floor_area": c.floor_area,
        "financial_status": c.financial_status,
        "business_status": c.business_status,
        "annual_power_usage": c.annual_power_usage,
        "daily_operate_hours": c.daily_operate_hours,
        # 归属 / 审计
