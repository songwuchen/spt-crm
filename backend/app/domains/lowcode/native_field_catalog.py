...
_CONTRACT_LINE_COLUMNS: list[dict[str, Any]] = [
    _col("is_fx", "是否外币合同", "radio", options=_YES_NO, required=True,
         aliases=["_widget_1621411268784"], width=120, align="center"),
    _col("product_type", "产品类型", "select", options=_LINE_PRODUCT_TYPES, required=True,
         aliases=["_widget_1561431500162"], width=130),
    _col("name", "产品名称", required=True, aliases=["_widget_1561431500376"], width=140),
    _col("spec", "规格型号", required=True, aliases=["_widget_1561431500392"], width=120),
    _col("unit", "单位", required=True, aliases=["_widget_1561431500419"], width=70, align="center"),
    _col("qty", "数量", "number", required=True, aliases=["_widget_1561431500458"], width=90, align="right"),
    _col("price", "单价", "amount", required=True, aliases=["_widget_1561431500490"], width=120, align="right"),
    _col("amount", "总价", "amount", aliases=["_widget_1561431500514"],
         width=130, align="right", computed=True),
    _col("fx_price", "外币单价", "number", required=True, aliases=["_widget_1621411268153"],
         width=110, align="right", show_when=_FX_SHOW),
    _col("fx_rate", "汇率", "number", required=True, aliases=["_widget_1621411269220"],
...
CATALOG: dict[str, list[dict[str, Any]]] = {
    ...
    "contract": [
        ...
        _f("project_id", "关联商机", "project", form_editable=True, available_on_create=True,
        ...
        _f("drawing_no", "图纸编号", form_editable=False, available_on_create=True, default_required=False),
        _f("peer_contract_no", "对方合同号", default_required=True),
        ...
        _f("project_name", "项目名称", json_storage="registration_json", default_required=True),
        ...
        _f("payment_desc", "付款方式文字描述", json_storage="registration_json", default_required=True),
        ...
        _f("application_field", "应用领域", "select", json_storage="registration_json", default_required=True),
        _f("application_material", "应用物料", "select", json_storage="registration_json", default_required=True),
