...
JDY_ROLE_TO_CRM_CODE: dict[str, str] = {
    ...
    # 230902客服内勤（客服落实 / 客服补登 / 延期反馈备案 / 往来函件内勤）
    ...
    # 发货通知
    "5f699f9a4f8b410006f2819f": "logistics_approval",  # 物流审批
...
JDY_ROLE_TO_SPECIFIED_USER: dict[str, str] = {
    ...
    # 客服领图「部门指派-研管办」← 27.3图纸领用申请-研究院安排 → 郑志颖
    "5f46008a6344180006bfa81a": "013807685436426800",
}
JDY_ROLE_NAME_TO_SPECIFIED_USER: dict[str, str] = {
    ...
    "27.3图纸领用申请-研究院安排": "013807685436426800",
}
